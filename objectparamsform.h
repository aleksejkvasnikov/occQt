...
signals:
    ...
    void coneReady(gp_Pnt p, double r1, double r2, double h);
    void sphereReady(gp_Pnt p, double r);
    void cylinderReady(gp_Pnt p, double r,double h, double angle);
    void torusReady(gp_Pnt p, double r1,double r2, double angle);
private slots:
